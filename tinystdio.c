...
struct param {
    ...
    unsigned char   prec;
    unsigned char   base;   /**<  number base (e.g.: 8, 10, 16) */
...
#if (PRINTF_LONG_SUPPORT && SIZEOF_LONG > SIZEOF_INT)
...
#if PRINTF_LONG_LONG_SUPPORT || (PRINTF_LONG_SUPPORT && SIZEOF_LONG > SIZEOF_INT)
